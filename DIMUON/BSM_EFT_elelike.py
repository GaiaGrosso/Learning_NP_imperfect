...
N_Data   = int(N_Bkg*float(sys.argv[11]))
#### Architecture: ###########################  
...
ID ='/EFT1_'+str(inputsize)+'D_expNfixed_Mcut'+str(M_cut)+'_PTcut'+str(PT_cut)+ '_ETAcut'+str(ETA_cut)
...
ID+='_patience'+str(patience)+'_ref'+str(N_ref)+'_bkg'+str(N_Bkg)+'_data'+str(N_Data)
